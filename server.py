...
def generate_mac(message: bytes) -> str:
    # استخدام SHA256 على المفتاح + الرسالة بدون HMAC
...
def main():
    ...
    print("=== Server Simulation (Using simple SHA256 with key prefix) ===")
    ...
    forged_mac = mac  # مجرد مثال، في الهجوم الحقيقي المفروض تولد forged_mac جديدة
